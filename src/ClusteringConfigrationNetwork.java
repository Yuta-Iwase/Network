...
public class ClusteringConfigrationNetwork extends Network{
	...
	public ClusteringConfigrationNetwork(int[] isolated_DegreeList,int loopLimit) {
		generate(degree, loopLimit);
	}

	public ClusteringConfigrationNetwork(int[] isolated_DegreeList,int loopLimit,boolean message){
