...
public class AirportTest23_4PROTO_VERSION_WeightTrimodal_OnRandom_withoutPoworlaw extends Job{
	private static final long serialVersionUID = 1L;

	public static void main(String[] args) {
		AirportTest23_4PROTO_VERSION_WeightTrimodal_OnRandom_withoutPoworlaw job = new AirportTest23_4PROTO_VERSION_WeightTrimodal_OnRandom_withoutPoworlaw();
