...
public class AirportTest17_1_4_RWSalience {
	public static void main(String[] args) throws Exception{
		PrintWriter pw = new PrintWriter(new File("USairport500_RWSalience.csv"));

		NetworkForCSVFile net = new NetworkForCSVFile("USairport500_reinforcedRW.csv",false,true,false,false);
		net.setNode(false);
