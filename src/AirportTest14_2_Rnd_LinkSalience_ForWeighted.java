...
// AirportTest7_LinkSalience_ForWeightedを参考に作成

public class AirportTest14_2_Rnd_LinkSalience_ForWeighted {

	public static void main(String[] args) {
		AirportTest14_Randomize net = new AirportTest14_Randomize();
		...
		for(int i=0;i<edge.size();i++){
			System.out.println(i+ "," + net.weight[i] + "," + edge.get(i).linkSalience);
		}
