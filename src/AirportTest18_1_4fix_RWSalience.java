...
public class AirportTest18_1_4fix_RWSalience {
	public static void main(String[] args) throws Exception{
		String folderName = "USAirport/";

		PrintWriter pw = new PrintWriter(new File(folderName + "USAirport_RWSalience.csv"));

		NetworkForCSVFile net = new NetworkForCSVFile(folderName + "USAirport_reinforcedRW.csv",false,true,false,false);
		net.setNode(false);
