...
public class AirportTest17_3_2_OriginalNetworkSalience {
	public static void main(String[] args) throws Exception{
		PrintWriter pw = new PrintWriter(new File("Florida_OriginalSalience.csv"));

		NetworkForCSVFile net = new NetworkForCSVFile("Florida_weighted.csv",false,true,false,false);
		net.setNode(false);
