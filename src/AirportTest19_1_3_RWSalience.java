...
public class AirportTest19_1_3_RWSalience {
	public static void main(String[] args) throws Exception{
		double point = 1.0;

		String folderName = "WorldAir/";

		PrintWriter pw = new PrintWriter(new File(folderName + "WorldAir_RRW" + point + "_s.csv"));

		NetworkForCSVFile net = new NetworkForCSVFile(folderName + "WorldAir_RRW" + point + ".csv",false,true,false,false);
		net.setNode(false);
