...
public class AirportTest23_3PROTO_VERSION_WeightTrimodal_OnConfig_withoutPoworlaw extends Job{
	private static final long serialVersionUID = 1L;

	public static void main(String[] args) {
		AirportTest23_3PROTO_VERSION_WeightTrimodal_OnConfig_withoutPoworlaw job = new AirportTest23_3PROTO_VERSION_WeightTrimodal_OnConfig_withoutPoworlaw();
