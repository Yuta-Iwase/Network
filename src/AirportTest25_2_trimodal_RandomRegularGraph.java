...
public class AirportTest25_2_trimodal_RandomRegularGraph extends Job {

	public static void main(String[] args) {
		AirportTest25_2_trimodal_RandomRegularGraph job = new AirportTest25_2_trimodal_RandomRegularGraph();
		job.run("param.ini");
	...
	public void job(ArrayList<Object> controlParameterList) {
		...
		int degree = Integer.parseInt(controlParameterList.get(inputIndex++).toString());
		...
		for(int t=0;t<times;t++) {
			// Network生成
			do{
				net = new ConfigrationNetwork(dist, 50);
			}while(!net.success);
