...
public class AirportTest19_1_1_OriginalNetworkSalience {
	public static void main(String[] args) throws Exception{
		String folderName = "WorldAir/";

		PrintWriter pw = new PrintWriter(new File(folderName + "WorldAir_OriginalSalience.csv"));


		NetworkForCSVFile net = new NetworkForCSVFile(folderName + "WorldAir_weighted.csv",false,true,false,false);
		net.setNode(false);
