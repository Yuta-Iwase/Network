...
public class AirportTest32_3_reinforcedRW_moveDeltaW extends Job{

	public static void main(String[] args) {
		AirportTest32_3_reinforcedRW_moveDeltaW job = new AirportTest32_3_reinforcedRW_moveDeltaW();
		job.run("param.ini");
...
//		job.run(list);
	...
	public void job(ArrayList<Object> controlParameterList) {
		...
		for(int t=0;t<times;t++){
			...
			net.setEdge();
			// 計算
			net.ReinforcedRandomWalk(step, deltaW, true);
//			net.BiasedRandomWalk(step, 1.0, alpha, 0.0, true);
		...
		try{
			...
			folderName = "reinforcedRW_deltaW=" + deltaW;
			...
			parameterLabels.add("times");parameterLabels.add("deltaW");
