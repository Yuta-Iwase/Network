...
public class AirportTest17_3_4_RWSalience {
	public static void main(String[] args) throws Exception{
		PrintWriter pw = new PrintWriter(new File("Florida_RWSalience.csv"));

		NetworkForCSVFile net = new NetworkForCSVFile("Florida_reinforcedRW.csv",false,true,false,false);
		net.setNode(false);
